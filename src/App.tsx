  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            >
              Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600">Oifi</span>
            </motion.h1>
            <motion.p
            ...
            >
              ...
              Passionate about clean code, innovative design, and solving complex problems through elegant solutions.
            </motion.p>
            <motion.div
      ...
      >
        <div className="px-4 sm:px-6 lg:px-8">
          <motion.div className="text-center mb-16" variants={itemVariants}>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">About Me</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto mb-8"></div>
          </motion.div>
          <div className="grid md:grid-cols-2 gap-12">
            <motion.div variants={slideInLeftVariants}>
              <motion.h3 className="text-3xl font-semibold text-gray-900 mb-6" variants={itemVariants}>
                Who I Am
              </motion.h3>
              <motion.p className="text-lg text-gray-600 mb-6 leading-relaxed" variants={itemVariants}>
                ...
                to building meaningful applications.
              </motion.p>
            ...
            <motion.div className="space-y-6" variants={slideInRightVariants}>
              ...
              >
                ...
                <p className="text-sm text-gray-500">University of Technology, 2019</p>
              </motion.div>
              <motion.div
                className="bg-gray-50 p-6 rounded-lg"
                variants={itemVariants}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-10 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-semibold text-gray-900 mb-2">Frontend</h3>
              </div>
                ...
                {['React', 'TypeScript', 'Next.js', 'Tailwind CSS', 'Vue.js', 'Angular'].map((skill) => (
                  <div key={skill} className="flex items-center justify-between">
                    ...
                    <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-blue-500 to-blue-600 rounded-full skill-bar" style={{width: '85%'}}></div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white p-10 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-semibold text-gray-900 mb-2">Backend</h3>
              </div>
              <div className="space-y-4">
                {['Node.js', 'Python', 'PostgreSQL', 'MongoDB', 'Redis', 'GraphQL'].map((skill) => (
                  <div key={skill} className="flex items-center justify-between">
                    <span className="text-gray-700 font-medium">{skill}</span>
                    <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-green-500 to-green-600 rounded-full skill-bar" style={{width: '80%'}}></div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white p-10 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-semibold text-gray-900 mb-2">Tools & Others</h3>
              </div>
              <div className="space-y-4">
                {['Docker', 'AWS', 'Git', 'Figma', 'Jest', 'Webpack'].map((skill) => (
                  <div key={skill} className="flex items-center justify-between">
                    <span className="text-gray-700 font-medium">{skill}</span>
                    <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-purple-500 to-purple-600 rounded-full skill-bar" style={{width: '75%'}}></div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gray-800 rounded-xl shadow-2xl overflow-hidden border border-gray-700">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed">
                <div className="space-y-2">
                  <div><span className="text-blue-400">import</span> <span className="text-white">React, &#123; useState, useEffect &#125;</span> <span className="text-blue-400">from</span> <span className="text-green-400">'react'</span>;</div>
                  <div><span className="text-blue-400">import</span> <span className="text-white">axios</span> <span className="text-blue-400">from</span> <span className="text-green-400">'axios'</span>;</div>
                  <div></div>
                  <div><span className="text-blue-400">const</span> <span className="text-yellow-400">Portfolio</span> = () = &#123;</div>
                  <div className="ml-4"><span className="text-blue-400">const</span> [projects, setProjects] = <span className="text-yellow-400">useState</span>([]);</div>
                  <div className="ml-4"><span className="text-blue-400">const</span> [loading, setLoading] = <span className="text-yellow-400">useState</span>(<span className="text-blue-400">true</span>);</div>
                  <div></div>
                  <div className="ml-4"><span className="text-blue-400">useEffect</span>(() = &#123;</div>
                  <div className="ml-8"><span className="text-blue-400">const</span> fetchProjects = <span className="text-blue-400">async</span> () = &#123;</div>
                  <div className="ml-12"><span className="text-blue-400">try</span> &#123;</div>
                  <div className="ml-16"><span className="text-blue-400">const</span> response = <span className="text-blue-400">await</span> axios.<span className="text-yellow-400">get</span>('<span className="text-green-400">/api/projects</span>');</div>
                  <div className="ml-16">setProjects(response.<span className="text-white">data</span>);</div>
                  <div className="ml-12">&#125; <span className="text-blue-400">catch</span> (error) &#123;</div>
                  <div className="ml-16"><span className="text-red-400">console</span>.<span className="text-yellow-400">error</span>('Failed to fetch projects:', error);</div>
                  <div className="ml-12">&#125; <span className="text-blue-400">finally</span> &#123;</div>
                  <div className="ml-16">setLoading(<span className="text-blue-400">false</span>);</div>
                  ...
                  <div className="ml-8">&lt;<span className="text-orange-400">div</span> <span className="text-blue-300">className</span>=<span className="text-green-400">"portfolio"</span>&gt;</div>
                  <div className="ml-12">&#123;loading ? (</div>
                  <div className="ml-16">&lt;<span className="text-orange-400">LoadingSpinner</span> /&gt;</div>
                  <div className="ml-12">) : (</div>
                  <div className="ml-16">&lt;<span className="text-orange-400">ProjectGrid</span> <span className="text-blue-300">projects</span>=&#123;projects&#125; /&gt;</div>
                  <div className="ml-12">)&#125;</div>
                  <div className="ml-8">&lt;/<span className="text-orange-400">div</span>&gt;</div>
                  <div className="ml-4">);</div>
                  <div>&#125;;</div>
                  <div></div>
                  <div><span className="text-blue-400">export default</span> Portfolio;</div>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">Featured Projects</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto mb-8"></div>
          </div>
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center">
                    <div className="opacity-0 hover:opacity-100 transition-opacity duration-300 flex space-x-4">
                      ...
                      <a href={project.live} className="bg-white p-2 rounded-full shadow-lg hover:bg-gray-100 transition-colors">
      ...
      >
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-3xl font-semibold text-gray-900 mb-8">Let's Work Together</h3>
