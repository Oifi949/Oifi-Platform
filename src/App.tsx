...
function App() {
      ...
      >
        ...
        <div className="px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <motion.p
              className="text-xl md:text-2xl max-w-4xl text-gray-700 mb-12 mx-auto leading-relaxed"
              variants={itemVariants}
            >
            ...
            >
              ...
              <motion.button
                onClick={() => scrollToSection("contact")}
                className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-600 hover:text-black transition-all duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                transition={{ duration: 0.2 }}
              >
  ...
  <div className="grid gap-8 w-full max-w-7xl sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
    {[
      {
